...
{/* hamburger with shop */}
 ...
 { cardItem.length > 0 && <span className="absolute -top-2 left-4 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">
      ...
      <Link href={'/register'} className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200">
      Sign In
      </Link>
  ...
  { cardItem.length > 0 && <span className="absolute -top-1 left-6 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">
   ...
   {isOpen && <div className="navbar-menu relative z-50  3">
